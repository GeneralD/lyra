...
public struct WallpaperItemConfig {
...
extension WallpaperItemConfig: Sendable {}
extension WallpaperItemConfig: Equatable {}
...
extension WallpaperItemConfig {
    ...
    static func formatTime(_ interval: TimeInterval) -> String {
        ...
        let fracStr = String(format: "%g", frac)
