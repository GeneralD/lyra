...
graph LR
    ...
    subgraph Support["Provider / Support"]
        ...
        LyricsResolutionLog[LyricsResolutionLog]
    end
    ...
    LyricsRepository -.-> LyricsDataSource & SQLiteDataStore & LyricsResolutionLog
    ...
    style LyricsResolutionLog fill:#d57,stroke:#333,color:#fff
